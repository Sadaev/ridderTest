        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <table class="table-a w-full">
                ...
                <tr class="bg-gray-100">
                    ...
                    <th class="px-4 py-2">{{ __('auth.desiredDate') }}</th>
                ...
                @foreach($peoples as $people)
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            <button wire:click="edit({{ $people->id }})" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">{{ __('auth.Edit') }}</button>
                            <button wire:click="delete({{ $people->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">{{ __('auth.Delete') }}</button>
                        </td>
                    </tr>
