                    ...
                    <div class="">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                   id="email" placeholder="{{__('auth.fillIn')}} {{__('auth.email')}}" wire:model="email">
                        ...
                        @if($isEdit)
                            <div class="mb-4">
                                ...
                                <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    ...
                                    <option value="">{{__('auth.chooseValue')}}</option>
                                    <option value="underConsideration">{{__('auth.underConsideration')}}</option>
                                    <option value="rejected">{{__('auth.rejected')}}</option>
                                    <option value="approved">{{__('auth.approved')}}</option>
                                    <option value="noDataAvailable">{{__('auth.noDataAvailable')}}</option>
